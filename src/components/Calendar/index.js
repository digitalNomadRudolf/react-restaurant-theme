...
export default class Calendar extends Component {
    ...
    // this is a higher order function that takes a Date object as its argument and returns an event handler that can be
    // triggered to update the currently selected date in the state
    gotoDate = date => evt => {
    ...
    // month and year header including arrow controls for navigation
    renderMonthAndYear = () => {
        const { month, year } = this.state;

        // get month name from CALENDAR_MONTHS object map
